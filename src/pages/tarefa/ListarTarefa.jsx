...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardActions>
            <Button size="big" color='secondary' variant="contained" onClick={handleOpen}>Crie uma tarefa</Button>
            <Button size="big" color='warning' variant="outlined">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
